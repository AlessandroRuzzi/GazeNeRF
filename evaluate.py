...
def parse_args():
    ...
    add_arg("--num_epochs", type=int, default=150)
    ...
    add_arg("--img_dir", type=str, default="")
    ...
    add_arg("--model_path", type=str, default="")
    ...
    add_arg("--use_patch_gan_loss", type=bool, default=True)
